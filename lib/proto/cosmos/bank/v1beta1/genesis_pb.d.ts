...
export class GenesisState extends jspb.Message { 
    ...
    setParams(value?: cosmos_bank_v1beta1_bank_pb.Params): GenesisState;
    clearBalancesList(): void;
    getBalancesList(): Array<Balance>;
    setBalancesList(value: Array<Balance>): GenesisState;
    addBalances(value?: Balance, index?: number): Balance;
    clearSupplyList(): void;
    getSupplyList(): Array<cosmos_base_v1beta1_coin_pb.Coin>;
    setSupplyList(value: Array<cosmos_base_v1beta1_coin_pb.Coin>): GenesisState;
    ...
    setDenomMetadataList(value: Array<cosmos_bank_v1beta1_bank_pb.Metadata>): GenesisState;
