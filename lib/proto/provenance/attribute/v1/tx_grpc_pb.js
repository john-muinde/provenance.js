...
function serialize_provenance_attribute_v1_MsgUpdateParamsRequest(arg) {
  if (!(arg instanceof provenance_attribute_v1_tx_pb.MsgUpdateParamsRequest)) {
    throw new Error('Expected argument of type provenance.attribute.v1.MsgUpdateParamsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_attribute_v1_MsgUpdateParamsRequest(buffer_arg) {
  return provenance_attribute_v1_tx_pb.MsgUpdateParamsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_provenance_attribute_v1_MsgUpdateParamsResponse(arg) {
  if (!(arg instanceof provenance_attribute_v1_tx_pb.MsgUpdateParamsResponse)) {
    throw new Error('Expected argument of type provenance.attribute.v1.MsgUpdateParamsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_attribute_v1_MsgUpdateParamsResponse(buffer_arg) {
  return provenance_attribute_v1_tx_pb.MsgUpdateParamsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
updateParams: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: provenance_attribute_v1_tx_pb.MsgUpdateParamsRequest,
    responseType: provenance_attribute_v1_tx_pb.MsgUpdateParamsResponse,
    requestSerialize: serialize_provenance_attribute_v1_MsgUpdateParamsRequest,
    requestDeserialize: deserialize_provenance_attribute_v1_MsgUpdateParamsRequest,
    responseSerialize: serialize_provenance_attribute_v1_MsgUpdateParamsResponse,
    responseDeserialize: deserialize_provenance_attribute_v1_MsgUpdateParamsResponse,
  },
};
