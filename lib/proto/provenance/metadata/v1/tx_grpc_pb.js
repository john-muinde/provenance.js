...
function serialize_provenance_metadata_v1_MsgAddNetAssetValuesRequest(arg) {
  if (!(arg instanceof provenance_metadata_v1_tx_pb.MsgAddNetAssetValuesRequest)) {
    throw new Error('Expected argument of type provenance.metadata.v1.MsgAddNetAssetValuesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_metadata_v1_MsgAddNetAssetValuesRequest(buffer_arg) {
  return provenance_metadata_v1_tx_pb.MsgAddNetAssetValuesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_provenance_metadata_v1_MsgAddNetAssetValuesResponse(arg) {
  if (!(arg instanceof provenance_metadata_v1_tx_pb.MsgAddNetAssetValuesResponse)) {
    throw new Error('Expected argument of type provenance.metadata.v1.MsgAddNetAssetValuesResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_metadata_v1_MsgAddNetAssetValuesResponse(buffer_arg) {
  return provenance_metadata_v1_tx_pb.MsgAddNetAssetValuesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
addNetAssetValues: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: provenance_metadata_v1_tx_pb.MsgAddNetAssetValuesRequest,
    responseType: provenance_metadata_v1_tx_pb.MsgAddNetAssetValuesResponse,
    requestSerialize: serialize_provenance_metadata_v1_MsgAddNetAssetValuesRequest,
    requestDeserialize: deserialize_provenance_metadata_v1_MsgAddNetAssetValuesRequest,
    responseSerialize: serialize_provenance_metadata_v1_MsgAddNetAssetValuesResponse,
    responseDeserialize: deserialize_provenance_metadata_v1_MsgAddNetAssetValuesResponse,
  },
};
