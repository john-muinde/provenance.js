...
function serialize_provenance_metadata_v1_GetByAddrRequest(arg) {
  if (!(arg instanceof provenance_metadata_v1_query_pb.GetByAddrRequest)) {
    throw new Error('Expected argument of type provenance.metadata.v1.GetByAddrRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_metadata_v1_GetByAddrRequest(buffer_arg) {
  return provenance_metadata_v1_query_pb.GetByAddrRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_provenance_metadata_v1_GetByAddrResponse(arg) {
  if (!(arg instanceof provenance_metadata_v1_query_pb.GetByAddrResponse)) {
    throw new Error('Expected argument of type provenance.metadata.v1.GetByAddrResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_metadata_v1_GetByAddrResponse(buffer_arg) {
  return provenance_metadata_v1_query_pb.GetByAddrResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_provenance_metadata_v1_QueryScopeNetAssetValuesRequest(arg) {
  if (!(arg instanceof provenance_metadata_v1_query_pb.QueryScopeNetAssetValuesRequest)) {
    throw new Error('Expected argument of type provenance.metadata.v1.QueryScopeNetAssetValuesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_metadata_v1_QueryScopeNetAssetValuesRequest(buffer_arg) {
  return provenance_metadata_v1_query_pb.QueryScopeNetAssetValuesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_provenance_metadata_v1_QueryScopeNetAssetValuesResponse(arg) {
  if (!(arg instanceof provenance_metadata_v1_query_pb.QueryScopeNetAssetValuesResponse)) {
    throw new Error('Expected argument of type provenance.metadata.v1.QueryScopeNetAssetValuesResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_metadata_v1_QueryScopeNetAssetValuesResponse(buffer_arg) {
  return provenance_metadata_v1_query_pb.QueryScopeNetAssetValuesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
getByAddr: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: provenance_metadata_v1_query_pb.GetByAddrRequest,
    responseType: provenance_metadata_v1_query_pb.GetByAddrResponse,
    requestSerialize: serialize_provenance_metadata_v1_GetByAddrRequest,
    requestDeserialize: deserialize_provenance_metadata_v1_GetByAddrRequest,
    responseSerialize: serialize_provenance_metadata_v1_GetByAddrResponse,
    responseDeserialize: deserialize_provenance_metadata_v1_GetByAddrResponse,
  },
...
scopeNetAssetValues: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: provenance_metadata_v1_query_pb.QueryScopeNetAssetValuesRequest,
    responseType: provenance_metadata_v1_query_pb.QueryScopeNetAssetValuesResponse,
    requestSerialize: serialize_provenance_metadata_v1_QueryScopeNetAssetValuesRequest,
    requestDeserialize: deserialize_provenance_metadata_v1_QueryScopeNetAssetValuesRequest,
    responseSerialize: serialize_provenance_metadata_v1_QueryScopeNetAssetValuesResponse,
    responseDeserialize: deserialize_provenance_metadata_v1_QueryScopeNetAssetValuesResponse,
  },
};
