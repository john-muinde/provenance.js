...
function serialize_provenance_marker_v1_QueryNetAssetValuesRequest(arg) {
  if (!(arg instanceof provenance_marker_v1_query_pb.QueryNetAssetValuesRequest)) {
    throw new Error('Expected argument of type provenance.marker.v1.QueryNetAssetValuesRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_marker_v1_QueryNetAssetValuesRequest(buffer_arg) {
  return provenance_marker_v1_query_pb.QueryNetAssetValuesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_provenance_marker_v1_QueryNetAssetValuesResponse(arg) {
  if (!(arg instanceof provenance_marker_v1_query_pb.QueryNetAssetValuesResponse)) {
    throw new Error('Expected argument of type provenance.marker.v1.QueryNetAssetValuesResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_provenance_marker_v1_QueryNetAssetValuesResponse(buffer_arg) {
  return provenance_marker_v1_query_pb.QueryNetAssetValuesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
netAssetValues: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: provenance_marker_v1_query_pb.QueryNetAssetValuesRequest,
    responseType: provenance_marker_v1_query_pb.QueryNetAssetValuesResponse,
    requestSerialize: serialize_provenance_marker_v1_QueryNetAssetValuesRequest,
    requestDeserialize: deserialize_provenance_marker_v1_QueryNetAssetValuesRequest,
    responseSerialize: serialize_provenance_marker_v1_QueryNetAssetValuesResponse,
    responseDeserialize: deserialize_provenance_marker_v1_QueryNetAssetValuesResponse,
  },
};
