...
var ibc_core_commitment_v2_commitment_pb = require('../../../../ibc/core/commitment/v2/commitment_pb.js');
...
function serialize_ibc_core_client_v1_QueryConsensusStateHeightsRequest(arg) {
  if (!(arg instanceof ibc_core_client_v1_query_pb.QueryConsensusStateHeightsRequest)) {
    throw new Error('Expected argument of type ibc.core.client.v1.QueryConsensusStateHeightsRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_ibc_core_client_v1_QueryConsensusStateHeightsRequest(buffer_arg) {
  return ibc_core_client_v1_query_pb.QueryConsensusStateHeightsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ibc_core_client_v1_QueryConsensusStateHeightsResponse(arg) {
  if (!(arg instanceof ibc_core_client_v1_query_pb.QueryConsensusStateHeightsResponse)) {
    throw new Error('Expected argument of type ibc.core.client.v1.QueryConsensusStateHeightsResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_ibc_core_client_v1_QueryConsensusStateHeightsResponse(buffer_arg) {
  return ibc_core_client_v1_query_pb.QueryConsensusStateHeightsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_ibc_core_client_v1_QueryVerifyMembershipRequest(arg) {
  if (!(arg instanceof ibc_core_client_v1_query_pb.QueryVerifyMembershipRequest)) {
    throw new Error('Expected argument of type ibc.core.client.v1.QueryVerifyMembershipRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_ibc_core_client_v1_QueryVerifyMembershipRequest(buffer_arg) {
  return ibc_core_client_v1_query_pb.QueryVerifyMembershipRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_ibc_core_client_v1_QueryVerifyMembershipResponse(arg) {
  if (!(arg instanceof ibc_core_client_v1_query_pb.QueryVerifyMembershipResponse)) {
    throw new Error('Expected argument of type ibc.core.client.v1.QueryVerifyMembershipResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_ibc_core_client_v1_QueryVerifyMembershipResponse(buffer_arg) {
  return ibc_core_client_v1_query_pb.QueryVerifyMembershipResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
consensusStateHeights: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ibc_core_client_v1_query_pb.QueryConsensusStateHeightsRequest,
    responseType: ibc_core_client_v1_query_pb.QueryConsensusStateHeightsResponse,
    requestSerialize: serialize_ibc_core_client_v1_QueryConsensusStateHeightsRequest,
    requestDeserialize: deserialize_ibc_core_client_v1_QueryConsensusStateHeightsRequest,
    responseSerialize: serialize_ibc_core_client_v1_QueryConsensusStateHeightsResponse,
    responseDeserialize: deserialize_ibc_core_client_v1_QueryConsensusStateHeightsResponse,
  },
...
verifyMembership: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ibc_core_client_v1_query_pb.QueryVerifyMembershipRequest,
    responseType: ibc_core_client_v1_query_pb.QueryVerifyMembershipResponse,
    requestSerialize: serialize_ibc_core_client_v1_QueryVerifyMembershipRequest,
    requestDeserialize: deserialize_ibc_core_client_v1_QueryVerifyMembershipRequest,
    responseSerialize: serialize_ibc_core_client_v1_QueryVerifyMembershipResponse,
    responseDeserialize: deserialize_ibc_core_client_v1_QueryVerifyMembershipResponse,
  },
};
