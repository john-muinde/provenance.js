...
export class MsgCreateClientResponse extends jspb.Message { 
    getClientId(): string;
    setClientId(value: string): MsgCreateClientResponse;
...
export class MsgUpdateClient extends jspb.Message { 
    ...
    setClientMessage(value?: google_protobuf_any_pb.Any): MsgUpdateClient;
    getSigner(): string;
...
export class MsgRecoverClient extends jspb.Message { 
    ...
    setSubjectClientId(value: string): MsgRecoverClient;
    getSubstituteClientId(): string;
    setSubstituteClientId(value: string): MsgRecoverClient;
    getSigner(): string;
    setSigner(value: string): MsgRecoverClient;
...
export class MsgIBCSoftwareUpgrade extends jspb.Message { 
    ...
    setPlan(value?: cosmos_upgrade_v1beta1_upgrade_pb.Plan): MsgIBCSoftwareUpgrade;

    hasUpgradedClientState(): boolean;
    clearUpgradedClientState(): void;
    getUpgradedClientState(): google_protobuf_any_pb.Any | undefined;
    setUpgradedClientState(value?: google_protobuf_any_pb.Any): MsgIBCSoftwareUpgrade;
    getSigner(): string;
    setSigner(value: string): MsgIBCSoftwareUpgrade;
...
export class MsgUpdateParams extends jspb.Message { 
    ...
    setParams(value?: ibc_core_client_v1_client_pb.Params): MsgUpdateParams;
